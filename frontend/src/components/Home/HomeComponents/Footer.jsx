...
//           <h1 className="text-4xl font-bold text-white">PlaceX</h1>
//         </div>
...
//           </h3>
//           <ul className="space-y-2 text-gray-400">
//             <li>krishnam.23bce@vitbhopal.ac.in</li>
...
//         © {new Date().getFullYear()} PlaceX. All rights reserved.
//       </div>
//     </footer>
//   );
// };
